...
const ShapeGrid: React.FC<ShapeGridProps> = ({
    ...
    shape = 'square',
    hoverTrailAmount = 0,
    overlayInnerColor = 'rgba(0,0,0,0)',
    overlayOuterColor = '#120F17'
}) => {
    ...
    useEffect(() => {
        ...
        const drawGrid = () => {
            ...
            gradient.addColorStop(0, overlayInnerColor);
            gradient.addColorStop(1, overlayOuterColor);
